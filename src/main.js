...
async function editFiles(options) {
  ...
  // file 1
  var data1 = fs.readFileSync(filePath, 'utf-8');
  var newValue1 = data1.replace(/<RWP Plugin>/g, options.pluginName)
  ...
  // file 2
  var data2 = fs.readFileSync(filePath2, 'utf-8');
  var newValue2 = data2.replace(/<WP_React_Plugin_Options>/g, safeSpacedNameOptions)
  ...
  // file 3
  var data3 = fs.readFileSync(filePath3, 'utf-8');
  var newValue3 = data3.replace(/<wp-react-plugin>/g, idVersionName)
